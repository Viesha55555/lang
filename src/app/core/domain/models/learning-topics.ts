  ...
  },
  {
    ...
    dialogueByLevel: {
      ...
      B1: [
        ...
        { speaker: 'user', text: 'De koffie is koud, hoewel het eten lekker is.', instruction: 'The coffee is cold, although the food is tasty. Say that.', targetTemplate: '…, hoewel …' },
        { speaker: 'app', text: 'Wilt u een nieuwe koffie?', translation: 'Would you like a new coffee?' },
        { speaker: 'user', text: 'Ja, omdat deze koud is, wil ik een nieuwe.', instruction: 'Yes, because this one is cold, you want a new one. Say that.', targetTemplate: 'Omdat …, wil ik …' },
      ],
    },
  },
  {
